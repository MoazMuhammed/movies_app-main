...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      lazy: false,
  create: (context) => sl<MoviesDetailsBloc>()..add(GetMoviesDetailsEvent(id))..add(GetMoviesRecommendEvent(id)),
  child: Scaffold(
                 ...
                 background: FadeIn(
                   ...
                   child: ShaderMask(
                     ...
                     child: CachedNetworkImage(
                       ...
                       imageUrl: AppConstance.imageUrl(state.moviesDetails!.backdropPath),
                       fit: BoxFit.cover,
                     ),
                   ),
                 ),
